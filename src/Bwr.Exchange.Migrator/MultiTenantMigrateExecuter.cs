...
namespace Bwr.Exchange.Migrator
{
    public class MultiTenantMigrateExecuter : ITransientDependency
    {
        ...
        {
            var tt = new ConnectionStringResolveArgs(MultiTenancySides.Host);
            var hostConnStr = CensorConnectionString(_connectionStringResolver.GetNameOrConnectionString(tt));
        ...
        {
            connectionString = connectionString.Replace("123", "555");
